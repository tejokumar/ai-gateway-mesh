...
.PHONY: help test vet validate docker-build compose-config compose-up compose-down compose-fallback compose-ollama demo-traffic demo-traffic-ollama ollama-pull
...
validate: test vet compose-config
